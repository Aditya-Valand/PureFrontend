    ...
    const fetchWithTimeout = async (formData) => {
      ...
      try {
        const response = await fetch('http://localhost:3000/process/analysis', {
          ...
          body: formData,
          headers: {
            'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..e616HP0NEpiUwNo9thRh80pJ_rTD4kgEjy4il2RxNiU'
          },
    ...
    const analyzeWithRetry = async () => {
      for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
        try {
          ...
          formData.append('images', blob, 'captured-image.jpg');
